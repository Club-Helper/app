        ...
        <SplitLayout modal={modal}>
          ...
          >
            <SlideStart platform={platform}>
              ...
              <Title level="1" weight="1" className="clubHelper--title clubHelper--title__1">Club Helper</Title>
            ...
            <SlideStart platform={platform}>
              <Title level="1" weight="1" className="clubHelper--title clubHelper--title__2">Ускорьте сортировку</Title>
            ...
            <SlideStart platform={platform}>
              <div className="clubHelper--bottom">
                ...
                <Title level="1" weight="1" className="clubHelper--title clubHelper--title__3">Улучшите фидбек</Title>
            ...
            {typeStartPage && <SlideStart platform={platform}>
              <div className="clubHelper--bottom">
                ...
                <Title level="1" weight="1" className="clubHelper--title clubHelper--title__4">Пара формальностей</Title>
            ...
            {!typeStartPage && <SlideStart platform={platform}>
              <div className="clubHelper--bottom">
                ...
                <Title level="1" weight="1" className="clubHelper--title clubHelper--title__4">Давайте приступим</Title>
